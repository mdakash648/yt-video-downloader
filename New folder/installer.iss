...
; including ffmpeg\ and aria2c\ if bundled) already exist -- this script
; just packages that whole folder into a proper installer.
;
; To compile:
...
; runtime, yt_dlp code, ffmpeg\ subfolder, aria2c\ subfolder if built with
; it, etc.) -- recursesubdirs makes sure ffmpeg\ffmpeg.exe / ffprobe.exe
; AND aria2c\aria2c.exe come along automatically. No changes needed here
; when aria2c is added -- this wildcard already covers it.
